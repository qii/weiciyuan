...
public class ShowcaseView extends RelativeLayout
    ...
    /**
     * @deprecated This will soon become private. Use setShowcase with a {@link
     * com.espian.showcaseview.targets.PointTarget}
     */
    @Deprecated
     ...
     */
    private static ShowcaseView insertShowcaseViewInternal(Target target, Activity activity,
            String title,
    ...
    public static ShowcaseView insertShowcaseView(Target target, Activity activity, int title,
            int detail) {
        return insertShowcaseViewInternal(target, activity, activity.getString(title),
                activity.getString(detail), null);
    }
    ...
    public static ShowcaseView insertShowcaseView(Target target, Activity activity, int title,
        ...
        return insertShowcaseViewInternal(target, activity, activity.getString(title),
                activity.getString(detail), options);
    }
    ...
    public static class ConfigOptions {
         ...
         * Showcase you want to use. If you want to use this in the {@link ShowcaseViews} class,
         * you

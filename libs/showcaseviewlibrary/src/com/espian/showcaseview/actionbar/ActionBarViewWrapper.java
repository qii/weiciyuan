...
public class ActionBarViewWrapper {
    ...
    /**
     * Return the view which represents the overflow action item on the ActionBar, or null if there
     * isn't one
     */
    public View getOverflowView() {
        try {
            Field actionMenuPresenterField = mAbsActionBarViewClass
            ...
            Field overflowButtonField = actionMenuPresenter.getClass()
    ...
    public View getActionItem(int actionItemId) {
        try {
            ...
            Field menuViewField = actionMenuPresenter.getClass().getSuperclass()
